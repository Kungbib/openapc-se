...
dt_apc_se$is_hybrid <- factor(dt_apc_se$is_hybrid, levels = c('TRUE','FALSE'), labels = c('Hybrid OA', 'Gold OA'))
...
# Set colours
colour <- c("#5F9EF0", "#E1B378")
apc_plot <- apc_plot + scale_colour_manual(values=colour)
