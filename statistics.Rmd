...
my.apc <- read.csv("data/apc_se.csv", header = TRUE, sep =",", encoding = "UTF-8")
# Combine with acronym-name-map to get full organisation names
code_name <- read.csv("data/org_acronym_name_map.tsv", header = TRUE, sep ="\t", encoding = "UTF-8")
...
# Create a Springer Compact subset
my.apc_sc <- my.apc_hybrid[(my.apc_hybrid$publisher == "Springer" & my.apc_hybrid$euro == 2200), ]
...
This is an example of statistics from the pilot project Open APC Sweden, aiming at gathering data about article processing charges (APC's) paid by Swedish universities. The statistics cover journal articles from a few pilot contributors. Please see the [project wiki](https://github.com/Kungbib/openapc-se/wiki) for more information about the project and instructions on how to contribute.

## Contributing organisations and publishers

Nine Swedish universities have reported APC costs for their articles so far. These are: 
