...
apc_se_offset <- filter(apc_se, is_hybrid == TRUE & publisher == 'Springer' & euro == 2200 & period>2015)

#Create a non-offset subset
apc_se_not_offset <- anti_join(apc_se, apc_se_offset)
...
deliv_orgs <- c('kth', 'su', 'gu', 'slu', 'du', 'ltu', 'liu', 'mah', 'hv')
